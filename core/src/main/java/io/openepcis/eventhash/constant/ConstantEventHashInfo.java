...
public class ConstantEventHashInfo {
    ...
    public static final List<String> TIME_ATTRIBUTE_LIST = List.of(EPCIS.EVENT_TIME, EPCIS.TIME, EPCIS.START_TIME, EPCIS.END_TIME);
    ...
    public static final Map<String, String> LIST_OF_OBJECTS = Map.ofEntries(
