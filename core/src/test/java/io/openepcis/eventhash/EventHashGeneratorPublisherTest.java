...
public class EventHashGeneratorPublisherTest {
  ...
  @Test
  void sensorComponent() throws IOException{
    final InputStream xmlStream = getClass().getClassLoader().getResourceAsStream("2.0/EPCIS/XML/Capture/Documents/epcisDocWithSensorComponent.xml");
    final InputStream jsonStream = getClass().getClassLoader().getResourceAsStream("2.0/EPCIS/JSON/Capture/Documents/epcisDocWithSensorComponent.json");
