...
ni:///sha-256;2615bc5627c3b3611e3df868aca2312882370ee78af44bcc20433ec028ebfc99?ver=CBV2.0
  ...
  public Multi<Map<String, String>> generateHashIdJSON(
      ...
      @Parameter(
              description =
                  "CBV version based on which Pre-Hash String and Hash-Id needs to be generated",
              schema =
                  @Schema(
  ...
  public Multi<String> generateHashIdText(
      ...
      @DefaultValue("") @QueryParam("ignoreFields") String ignoreFields,
  ...
  private Multi<Map<String, String>> getMulti(
      String contentType,
      InputStream inputDocumentStream,
      String hashAlgorithm,
      Boolean prehash,
      Boolean beautifyPreHash,
      String ignoreFields,
    ...
    final CBVVersion targetCbvVersion =
        CBVVersion.VERSION_2_1_0.equals(CBVVersion.of(cbvVersion))
            ? CBVVersion.VERSION_2_1_0
            : CBVVersion.VERSION_2_0_0;
              ...
              try {
                Multi<Map<String, String>> m =
                    getMulti(
                        ...
                        contentType.contains("application/xml")
                            ? inputDocumentStream
                            : documentWrapperSupport.generateJsonDocumentWrapper(
                                inputDocumentStream),
                        hashAlgorithm,
                        prehash,
                        beautifyPreHash,
