...
Servlet-based variant of the REST endpoint for non-Quarkus deployments. Generates Hash Ids for EPCIS documents in JSON/XML format using the project the
openepcis-event-hash-generator (ref: https://github.com/openepcis/openepcis-event-hash-generator).
